allProfessions = [{group : 0, color : 7, profession : 'MINER', labor : 'MINE', skill : 'MINING', label : "Mi", special : true},
// Woodworking
...
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'DANCE', label : "Dn"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'MAKE_MUSIC', label : "MM"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'SING_MUSIC', label : "SM"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'PLAY_KEYBOARD_INSTRUMENT', label : "PK"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'PLAY_STRINGED_INSTRUMENT', label : "PS"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'PLAY_WIND_INSTRUMENT', label : "PW"},
{group : 19, color : 6, profession : 'NONE', labor : 'NONE', skill : 'PLAY_PERCUSSION_INSTRUMENT', label : "PP"},

{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'CRITICAL_THINKING', label : "CT"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'LOGIC', label : "Lo"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'MATHEMATICS', label : "Ma"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'ASTRONOMY', label : "As"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'CHEMISTRY', label : "Ch"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'GEOGRAPHY', label : "Ge"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'OPTICS_ENGINEER', label : "OE"},
{group : 20, color : 4, profession : 'NONE', labor : 'NONE', skill : 'FLUID_ENGINEER', label : "FE"},
...
// Skill levels
skillLevels = [{name : "Dabbling",     points : 500,  abbr : '0'},
