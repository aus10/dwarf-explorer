...
var _user$project$Main$renderSkillsList = function (skills) {
	return A2(
								...
								[
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(s.ratingValue),
												A2(_elm_lang$core$Basics_ops['++'], ' ', s.ratingCaption)))))
								]))
						]));
			},
			skills));
...
var _user$project$Main$dwarfList = _elm_lang$core$Native_Platform.incomingPort(
	'dwarfList',
	_elm_lang$core$Json_Decode$list(
		A2(
			...
			function (name) {
				return A2(
					_elm_lang$core$Json_Decode$andThen,
					A2(_elm_lang$core$Json_Decode_ops[':='], 'profession', _elm_lang$core$Json_Decode$string),
					function (profession) {
						return A2(
							_elm_lang$core$Json_Decode$andThen,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'stressLevel', _elm_lang$core$Json_Decode$string),
							function (stressLevel) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'currentJob', _elm_lang$core$Json_Decode$string),
									function (currentJob) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(
												...
												_elm_lang$core$Json_Decode$list(
													A2(
														...
														function (name) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																A2(_elm_lang$core$Json_Decode_ops[':='], 'stackSize', _elm_lang$core$Json_Decode$int),
																function (stackSize) {
																	return A2(
																		_elm_lang$core$Json_Decode$andThen,
																		A2(_elm_lang$core$Json_Decode_ops[':='], 'subtype', _elm_lang$core$Json_Decode$string),
																		function (subtype) {
																			return _elm_lang$core$Json_Decode$succeed(
																				{name: name, stackSize: stackSize, subtype: subtype});
																		});
																});
														}))),
											function (inventory) {
												return A2(
													...
													function (buildings) {
														return A2(
																...
																_elm_lang$core$Json_Decode$list(
																	A2(
																		...
																		function (name) {
																			return A2(
																				_elm_lang$core$Json_Decode$andThen,
																				A2(_elm_lang$core$Json_Decode_ops[':='], 'ratingCaption', _elm_lang$core$Json_Decode$string),
																				function (ratingCaption) {
																					return A2(
																						_elm_lang$core$Json_Decode$andThen,
																						A2(_elm_lang$core$Json_Decode_ops[':='], 'ratingValue', _elm_lang$core$Json_Decode$int),
																						function (ratingValue) {
																							return A2(
																								_elm_lang$core$Json_Decode$andThen,
																								A2(_elm_lang$core$Json_Decode_ops[':='], 'xp', _elm_lang$core$Json_Decode$int),
																								function (xp) {
																									return A2(
																										_elm_lang$core$Json_Decode$andThen,
																										A2(_elm_lang$core$Json_Decode_ops[':='], 'maxXp', _elm_lang$core$Json_Decode$int),
																										function (maxXp) {
																											return _elm_lang$core$Json_Decode$succeed(
																												{name: name, ratingCaption: ratingCaption, ratingValue: ratingValue, xp: xp, maxXp: maxXp});
																										});
																								});
																						});
																				});
															...
															function (skills) {
																return _elm_lang$core$Json_Decode$succeed(
																	{name: name, profession: profession, stressLevel: stressLevel, currentJob: currentJob, inventory: inventory, buildings: buildings, skills: skills});
															});
													});
											});
									});
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {dwarves: a, selectedDwarf: b, selectedDwarfTab: c, mdl: d};
	});
var _user$project$Main$Dwarf = F7(
	function (a, b, c, d, e, f, g) {
		return {name: a, profession: b, stressLevel: c, currentJob: d, inventory: e, buildings: f, skills: g};
	});
var _user$project$Main$initDwarf = A7(
	_user$project$Main$Dwarf,
	'',
	'',
	'',
	'',
...
var _user$project$Main$Item = F3(
	function (a, b, c) {
		return {name: a, stackSize: b, subtype: c};
	});
var _user$project$Main$Building = function (a) {
	return {name: a};
};
var _user$project$Main$Skill = F5(
	function (a, b, c, d, e) {
		return {name: a, ratingCaption: b, ratingValue: c, xp: d, maxXp: e};
	});
var _user$project$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Main$SelectDwarfTab = function (a) {
	return {ctor: 'SelectDwarfTab', _0: a};
};
var _user$project$Main$renderDwarfDetails = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.selectedDwarf.name, '') ? _elm_lang$html$Html$text('No dwarf selected') : A6(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_debois$elm_mdl$Material_Tabs$onSelectTab(_user$project$Main$SelectDwarfTab),
				_debois$elm_mdl$Material_Tabs$activeTab(model.selectedDwarfTab)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text(model.selectedDwarf.name)
					])),
				A2(
				_debois$elm_mdl$Material_Tabs$label,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_debois$elm_mdl$Material_Icon$i('build'),
						A2(
						_debois$elm_mdl$Material_Options$span,
						_elm_lang$core$Native_List.fromArray(
							[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				function () {
				var _p1 = model.selectedDwarfTab;
				if (_p1 === 0) {
					return _elm_lang$html$Html$text('about');
				} else {
					return _user$project$Main$renderSkillsList(model.selectedDwarf.skills);
				}
			}()
			]));
};
var _user$project$Main$ClickDwarf = function (a) {
	return {ctor: 'ClickDwarf', _0: a};
};
var _user$project$Main$renderList = F2(
	function (list, selectedDwarf) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				_elm_lang$core$List$map,
				function (l) {
					var width = _elm_lang$core$Native_Utils.eq(l.name, selectedDwarf.name) ? '150px' : '128px';
					var fontWeight = _elm_lang$core$Native_Utils.eq(l.name, selectedDwarf.name) ? 'bold' : 'normal';
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Indigo, _debois$elm_mdl$Material_Color$S100)),
								_debois$elm_mdl$Material_Options$attribute(
								_elm_lang$html$Html_Events$onClick(
									_user$project$Main$ClickDwarf(l)))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												A2(_debois$elm_mdl$Material_Options$css, 'font-weight', fontWeight)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(l.name)
											]))
									]))
							]));
				},
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$Main$renderList, model.dwarves, model.selectedDwarf)
							])),
						A2(
						_debois$elm_mdl$Material_Grid$cell,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Main$renderDwarfDetails(model)
							]))
					]))
			]));
};
			...
			[_debois$elm_mdl$Material_Layout$fixedHeader]),
		{
			header: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Dwarf Explorer')
						]))
				]),
...
var _user$project$Main$RenderDwarves = function (a) {
	return {ctor: 'RenderDwarves', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$dwarfList(_user$project$Main$RenderDwarves);
};
